...
local function notify_ws(id)
	if id then
		hl.dispatch(hl.dsp.exec_cmd(
			"notify-send -a hyprland -t 1000 -u low -h string:x-canonical-private-synchronous:workspace 'Workspace " .. id .. "'"
		))
	else
...
hl.bind(mainMod .. " + code:10", function() hl.dispatch(hl.dsp.focus({ workspace = 1  })) notify_ws(1)  end) -- key 1
hl.bind(mainMod .. " + code:11", function() hl.dispatch(hl.dsp.focus({ workspace = 2  })) notify_ws(2)  end) -- key 2
hl.bind(mainMod .. " + code:12", function() hl.dispatch(hl.dsp.focus({ workspace = 3  })) notify_ws(3)  end) -- key 3
hl.bind(mainMod .. " + code:13", function() hl.dispatch(hl.dsp.focus({ workspace = 4  })) notify_ws(4)  end) -- key 4
hl.bind(mainMod .. " + code:14", function() hl.dispatch(hl.dsp.focus({ workspace = 5  })) notify_ws(5)  end) -- key 5
hl.bind(mainMod .. " + code:15", function() hl.dispatch(hl.dsp.focus({ workspace = 6  })) notify_ws(6)  end) -- key 6
hl.bind(mainMod .. " + code:16", function() hl.dispatch(hl.dsp.focus({ workspace = 7  })) notify_ws(7)  end) -- key 7
hl.bind(mainMod .. " + code:17", function() hl.dispatch(hl.dsp.focus({ workspace = 8  })) notify_ws(8)  end) -- key 8
hl.bind(mainMod .. " + code:18", function() hl.dispatch(hl.dsp.focus({ workspace = 9  })) notify_ws(9)  end) -- key 9
hl.bind(mainMod .. " + code:19", function() hl.dispatch(hl.dsp.focus({ workspace = 10 })) notify_ws(10) end) -- key 0

-- Move active window and follow to workspace mainMod + SHIFT [0-9]
hl.bind(mainMod .. " + SHIFT + code:10", function() hl.dispatch(hl.dsp.window.move({ workspace = 1  })) notify_ws(1)  end) -- key 1
hl.bind(mainMod .. " + SHIFT + code:11", function() hl.dispatch(hl.dsp.window.move({ workspace = 2  })) notify_ws(2)  end) -- key 2
hl.bind(mainMod .. " + SHIFT + code:12", function() hl.dispatch(hl.dsp.window.move({ workspace = 3  })) notify_ws(3)  end) -- key 3
hl.bind(mainMod .. " + SHIFT + code:13", function() hl.dispatch(hl.dsp.window.move({ workspace = 4  })) notify_ws(4)  end) -- key 4
hl.bind(mainMod .. " + SHIFT + code:14", function() hl.dispatch(hl.dsp.window.move({ workspace = 5  })) notify_ws(5)  end) -- key 5
hl.bind(mainMod .. " + SHIFT + code:15", function() hl.dispatch(hl.dsp.window.move({ workspace = 6  })) notify_ws(6)  end) -- key 6
hl.bind(mainMod .. " + SHIFT + code:16", function() hl.dispatch(hl.dsp.window.move({ workspace = 7  })) notify_ws(7)  end) -- key 7
hl.bind(mainMod .. " + SHIFT + code:17", function() hl.dispatch(hl.dsp.window.move({ workspace = 8  })) notify_ws(8)  end) -- key 8
hl.bind(mainMod .. " + SHIFT + code:18", function() hl.dispatch(hl.dsp.window.move({ workspace = 9  })) notify_ws(9)  end) -- key 9
hl.bind(mainMod .. " + SHIFT + code:19", function() hl.dispatch(hl.dsp.window.move({ workspace = 10 })) notify_ws(10) end) -- key 0
hl.bind(mainMod .. " + SHIFT + bracketleft",  function() hl.dispatch(hl.dsp.window.move({ workspace = "-1" })) notify_ws(nil) end)
hl.bind(mainMod .. " + SHIFT + bracketright", function() hl.dispatch(hl.dsp.window.move({ workspace = "+1" })) notify_ws(nil) end)
...
hl.bind(mainMod .. " + mouse_up",   function() hl.dispatch(hl.dsp.focus({ workspace = "e+1" })) notify_ws(nil) end)
hl.bind(mainMod .. " + mouse_down", function() hl.dispatch(hl.dsp.focus({ workspace = "e-1" })) notify_ws(nil) end)
hl.bind(mainMod .. " + period",     function() hl.dispatch(hl.dsp.focus({ workspace = "e+1" })) notify_ws(nil) end)
hl.bind(mainMod .. " + comma",      function() hl.dispatch(hl.dsp.focus({ workspace = "e-1" })) notify_ws(nil) end)
